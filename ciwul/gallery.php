  ...
  <body>
    ...
    <section id="tranding">
      ...
      <div class="container">
        ...
        <h1 class="text-center section-heading">Ryan &hearts; Ciwul</h1>
        <!--
      ...
      <!-- Swiper start -->
      <div class="container">
        <h1 class="text-center section-heading">16/12/2023</h1>
      </div>
      <div class="container">
        <div class="swiper tranding-slider">
          <div class="swiper-wrapper">
      ...
      <!-- Swiper start -->
      <div class="container">
        <h1 class="text-center section-heading">03/11/2023</h1>
      </div>
      <div class="container">
        <div class="swiper tranding-slider">
          <div class="swiper-wrapper">
